...
const gamingOffers: GamingOffer[] = [
  ...
  },
  {
    ...
    originalPrice: "9.99€",
    duration: "1 mois",
    description: "Gaming dans le cloud avec RTX",
    highlights: ["Sessions 6h", "RTX ON", "Priorité dans la file", "1080p 60fps"],
    url: "https://www.nvidia.com/fr-fr/geforce-now/",
    category: "cloud",
    rating: 4.4,
  ...
  },
  {
    ...
    originalPrice: "4.99€",
    duration: "1 mois",
    description: "Catalogue Electronic Arts",
    highlights: ["90+ jeux EA", "Accès anticipé", "Remises membres", "PC & Console"],
    url: "https://www.ea.com/ea-play",
    category: "abonnement",
    rating: 4.2,
    promotion: "-80% le 1er mois",
    playerCount: "13M+"
  },
  {
  ...
  },
  {
    ...
    category: "cloud",
    rating: 4.0,
    promotion: "-40% pendant 2 mois",
    playerCount: "Croissant"
  }
];
