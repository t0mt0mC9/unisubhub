  ...
  return [
    {
      ...
      merchant: 'Netflix',
      category: 'Streaming',
      url: 'https://www.dealabs.com/search?q=netflix',
      votes: 145,
      temperature: 89,
    ...
    },
    {
      ...
      merchant: 'Spotify',
      category: 'Musique',
      url: 'https://www.dealabs.com/search?q=spotify',
      votes: 203,
      temperature: 112,
    ...
    },
    {
      ...
      merchant: 'NordVPN',
      category: 'VPN',
      url: 'https://www.dealabs.com/search?q=nordvpn',
      votes: 167,
      temperature: 94,
    ...
    },
    {
      ...
      merchant: 'Disney+',
      category: 'Streaming',
      url: 'https://www.dealabs.com/search?q=disney',
      votes: 89,
      temperature: 76,
    ...
    },
    {
      ...
      merchant: 'YouTube',
      category: 'Streaming',
      url: 'https://www.dealabs.com/search?q=youtube+premium',
      votes: 134,
      temperature: 81,
    ...
    },
    {
      ...
      url: 'https://www.dealabs.com/search?q=adobe+creative+cloud',
      votes: 78,
      temperature: 65,
    ...
    },
    {
      ...
      merchant: 'Canal+',
      category: 'Streaming',
      url: 'https://www.dealabs.com/search?q=canal',
      votes: 156,
      temperature: 92,
    ...
    },
    {
      ...
      merchant: 'ExpressVPN',
      category: 'VPN',
      url: 'https://www.dealabs.com/search?q=expressvpn',
      votes: 112,
      temperature: 73,
