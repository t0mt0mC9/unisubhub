-- Supprimer complètement le système de parrainage avec CASCADE

-- Supprimer tous les triggers liés aux parrainages
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users CASCADE;
DROP TRIGGER IF EXISTS on_auth_user_created_referral ON auth.users CASCADE;

-- Supprimer toutes les fonctions liées aux parrainages
